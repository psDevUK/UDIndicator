...
$OutputPath = "$BuildFolder\output\UniversalDashboard.UDIndicator"
...
Copy-Item $BuildFolder\UniversalDashboard.UDIndicator.psm1 $OutputPath
Copy-Item $BuildFolder\Scripts $OutputPath\Scripts -Recurse -Force

$Version = "1.0.0"

$manifestParameters = @{
	Path = "$OutputPath\UniversalDashboard.UDIndicator.psd1"
	Author = "xxx"
	CompanyName = "Ironman Software, LLC"
	Copyright = "2019 Ironman Software, LLC"
	RootModule = "UniversalDashboard.UDIndicator.psm1"
	Description = ""
